    ...
    def _build_remotion_props(
        ...
        *,
        ...
        props = {
            ...
            "colors": visual_props.get("colors") or style.get("colors", ["#1a100c", "#2d1810"]),
            ...
            "useWeb3Background": bool(visual_props.get("use_web3_background", False)),
            "backgroundVariant": str(visual_props.get("background_variant") or ""),
